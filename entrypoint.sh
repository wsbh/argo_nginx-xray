...
ADD_SOCKS=${ADD_SOCKS:-'_socks'}
# 定义 UUID 及 伪装路径,请自行修改.(注意:伪装路径以 / 符号开始,为避免不必要的麻烦,请不要使用特殊符号.)
UUID=${UUID:-'de04add9-5c68-8bab-950c-08cd5320df18'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess'}
VMESS_WSPATH_SOCKS=${VMESS_WSPATH_SOCKS:-'/vmess_socks'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless'}
VLESS_WSPATH_SOCKS=${VLESS_WSPATH_SOCKS:-'/vless_socks'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan'}
TROJAN_WSPATH_SOCKS=${TROJAN_WSPATH_SOCKS:-'/trojan_socks'}
SS_WSPATH=${SS_WSPATH:-'/shadowsocks'}
SS_WSPATH_SOCKS=${SS_WSPATH_SOCKS:-'/shadowsocks_socks'}
#VMESS_WSPATH_SOCKS=$VMESS_WSPATH$ADD_SOCKS
#VLESS_WSPATH_SOCKS=$VLESS_WSPATH_SOCKS$ADD_SOCKS
#TROJAN_WSPATH_SOCKS=$TROJAN_WSPATH_SOCKS$ADD_SOCKS
#SS_WSPATH_SOCKS=$SS_WSPATH_SOCKS$ADD_SOCKS
SSS_WSPATH_SOCKS=$SS_WSPATH_SOCKS$ADD_SOCKS
VAR_NAMES=("UUID" "VMESS_WSPATH" "VLESS_WSPATH" "TROJAN_WSPATH" "SS_WSPATH" "DISPLAY_NAME" "ARGO_AUTH" "AGENT" "S_ADDR" "S_PORT" "VMESS_WSPATH_SOCKS" "VLESS_WSPATH_SOCKS" "TROJAN_WSPATH_SOCKS" "SS_WSPATH_SOCKS" "SSS_WSPATH_SOCKS")
