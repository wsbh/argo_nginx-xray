...
VAR_NAMES=("UUID" "VMESS_WSPATH" "VLESS_WSPATH" "TROJAN_WSPATH" "SS_WSPATH" "DISPLAY_NAME" "ARGO_AUTH" "AGENT" "UUID2" "S_ADDR" "S_PORT" "VMESS_WSPATH_SOCKS" "VLESS_WSPATH_SOCKS" "TROJAN_WSPATH_SOCKS" "SS_WSPATH_SOCKS")
